...
namespace Stock.WinFormsUI {
    ...
    public partial class StockDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductsRow AddProductsRow(string Name, string Brand, string Model, int Type, int WorkType, int Warranty, decimal Price, System.DateTime CreatedDate, System.DateTime UpdatedDate) {
        ...
        public partial class ProductsRow : global::System.Data.DataRow {
            ...
            public int WorkType {
                get {
                    return ((int)(this[this.tableProducts.WorkTypeColumn]));
                }
                set {
                    this[this.tableProducts.WorkTypeColumn] = value;
                }
            }
            ...
            public int Warranty {
                get {
                    try {
                        return ((int)(this[this.tableProducts.WarrantyColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace Stock.WinFormsUI.StockDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Products] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ((@IsNull_Brand = 1 AND [Brand] IS NULL) OR ([Brand] = @Original_Brand)) AND ((@IsNull_Model = 1 AND [Model] IS NULL) OR ([Model] = @Original_Model)) AND ([Type] = @Original_Type) AND ([WorkType] = @Original_WorkType) AND ((@IsNull_Warranty = 1 AND [Warranty] IS NULL) OR ([Warranty] = @Original_Warranty)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)) AND ([CreatedDate] = @Original_CreatedDate) AND ((@IsNull_UpdatedDate = 1 AND [UpdatedDate] IS NULL) OR ([UpdatedDate] = @Original_UpdatedDate)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Products] ([Name], [Brand], [Model], [Type], [WorkType], [Warranty], [Price], [CreatedDate], [UpdatedDate]) VALUES (@Name, @Brand, @Model, @Type, @WorkType, @Warranty, @Price, @CreatedDate, @UpdatedDate);
SELECT Id, Name, Brand, Model, Type, WorkType, Warranty, Price, CreatedDate, UpdatedDate FROM Products WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [Name] = @Name, [Brand] = @Brand, [Model] = @Model, [Type] = @Type, [WorkType] = @WorkType, [Warranty] = @Warranty, [Price] = @Price, [CreatedDate] = @CreatedDate, [UpdatedDate] = @UpdatedDate WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ((@IsNull_Brand = 1 AND [Brand] IS NULL) OR ([Brand] = @Original_Brand)) AND ((@IsNull_Model = 1 AND [Model] IS NULL) OR ([Model] = @Original_Model)) AND ([Type] = @Original_Type) AND ([WorkType] = @Original_WorkType) AND ((@IsNull_Warranty = 1 AND [Warranty] IS NULL) OR ([Warranty] = @Original_Warranty)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)) AND ([CreatedDate] = @Original_CreatedDate) AND ((@IsNull_UpdatedDate = 1 AND [UpdatedDate] IS NULL) OR ([UpdatedDate] = @Original_UpdatedDate)));
SELECT Id, Name, Brand, Model, Type, WorkType, Warranty, Price, CreatedDate, UpdatedDate FROM Products WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Stock.WinFormsUI.Properties.Settings.Default.StockConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Brand, Model, Type, WorkType, Warranty, Price, CreatedDate, Upda" +
                "tedDate FROM dbo.Products";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Brand, string Original_Model, int Original_Type, int Original_WorkType, global::System.Nullable<int> Original_Warranty, global::System.Nullable<decimal> Original_Price, System.DateTime Original_CreatedDate, global::System.Nullable<global::System.DateTime> Original_UpdatedDate) {
            ...
            this.Adapter.DeleteCommand.Parameters[7].Value = ((int)(Original_WorkType));
            if ((Original_Warranty.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[8].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[9].Value = ((int)(Original_Warranty.Value));
            }
            else {
        ...
        public virtual int Insert(string Name, string Brand, string Model, int Type, int WorkType, global::System.Nullable<int> Warranty, global::System.Nullable<decimal> Price, System.DateTime CreatedDate, global::System.Nullable<global::System.DateTime> UpdatedDate) {
            if ((Name == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[4].Value = ((int)(WorkType));
            if ((Warranty.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[5].Value = ((int)(Warranty.Value));
            }
            else {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(WorkType));
            if ((Warranty.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Warranty.Value));
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[16].Value = ((int)(Original_WorkType));
            if ((Original_Warranty.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[17].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[18].Value = ((int)(Original_Warranty.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    System.DateTime Original_CreatedDate, 
                    global::System.Nullable<global::System.DateTime> Original_UpdatedDate) {
            return this.Update(Name, Brand, Model, Type, WorkType, Warranty, Price, CreatedDate, UpdatedDate, Original_Id, Original_Name, Original_Brand, Original_Model, Original_Type, Original_WorkType, Original_Warranty, Original_Price, Original_CreatedDate, Original_UpdatedDate, Original_Id);
        }
    }
